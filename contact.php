    ...
    <div class="container">
     ...
     <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="contact.html">Set Appoinment</a></li>
        ...
        <div date-picker
          ...
          <div class="datepicker"
            ...
            <div class="datepicker-header">
              <?php include"forms/datechosen.php";?>
              <div class="datepicker-title" ng-if="datepicker_title">{{ datepickerTitle }}</div>
              <div class="datepicker-subheader"><?php echo $title; ?></div>
            </div>
                ...
                <div id="test" class="timepicker-container-outer">
                    <div class="form-group" id="testDiv">
                      ...
                      <select id="appointmentfor" name="appointmentfor" class="form-control" >
                          <option value="Service#1">Withdraw</option>
                          <option value="Service#2">Deposit</option>
                      </select><br>
                      <label for="addNotes" class="Notes">Additional Notes:</label>
                      <textarea id="addNotes" name="addNotes" rows="4" cols="45"></textarea>
                    </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="index.html">Home</a></li>
		          <li><i class="bx bx-chevron-right"></i> <a href="team.html">Profile</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="contact.html">Set Appointment</a></li>
            </ul>
          </div>
